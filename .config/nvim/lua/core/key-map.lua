...
keymap.set({'v','n'}, "<leader>P", "\"+P", {desc = "Paste from clipboard"})
keymap.set('x', "<leader>p", "\"_dh\"+p", {desc = "Paste from clipboard void selection"})
keymap.set('x', "<leader>P", "\"+p", {desc = "Paste from clipboard copy selection"})
keymap.set('x', 'p', "\"_dP", {desc= "Paste and void selection"})
keymap.set('x', 'P', "p", {desc= "Paste and copy selection"})
